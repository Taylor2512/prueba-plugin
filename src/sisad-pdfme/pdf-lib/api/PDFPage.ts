...
export default class PDFPage {
  ...
  setSize(width: number, height: number): void {
    ...
    const hasCropBox = this.node.CropBox() !== null;
    const hasBleedBox = this.node.BleedBox() !== null;
    const hasTrimBox = this.node.TrimBox() !== null;
    const hasArtBox = this.node.ArtBox() !== null;
