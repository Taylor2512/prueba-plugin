          ...
          >
            <Button
              ...
              onClick={() => {
                ...
                handleSchemaClick(cloneDeep(plugin.propPanel.defaultSchema) as unknown as Schema, pluginType);
              }}
            >
              <PluginIcon
                plugin={plugin}
          ...
          >
            <Button
              ...
              onClick={() => {
                ...
                if (!schema) return;
                handleSchemaClick(cloneDeep(schema) as unknown as Schema, definition.pluginType);
              }}
              >
                <span className={mergeClassNames(
