...
test.describe('sisad-pdfme - ui - components - Designer - RightSidebar - DetailView - SchemaConnectionsWidget.spec.ts', ()=>{
  test('SchemaConnectionsWidget.spec.ts renders', async ({ page }) => {
