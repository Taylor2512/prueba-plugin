// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/Canvas/overlays/SchemaDropCommitFlash.tsx. Regenerar con `npm test -- source-tests --apply`.
