// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/RightSidebar/DetailView/schemaDisplayInfo.ts. Regenerar con `npm test -- source-tests --apply`.
