// @generated — source-contract de src/sisad-pdfme/integration/http/integrationResources.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/integration/http/integrationResources.ts";

describe("src/sisad-pdfme/integration/http/integrationResources.ts", () => {
