// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/RightSidebar/ListView/longPressSelection.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/ui/components/Designer/RightSidebar/ListView/longPressSelection.ts";

describe("src/sisad-pdfme/ui/components/Designer/RightSidebar/ListView/longPressSelection.ts", () => {
