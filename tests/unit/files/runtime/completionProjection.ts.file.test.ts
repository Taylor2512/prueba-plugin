// @generated — source-contract de src/sisad-pdfme/runtime/completionProjection.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/completionProjection.ts";

describe("src/sisad-pdfme/runtime/completionProjection.ts", () => {
