// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/RightSidebar/ListView/reassignActionState.ts. Regenerar con `npm test -- source-tests --apply`.
