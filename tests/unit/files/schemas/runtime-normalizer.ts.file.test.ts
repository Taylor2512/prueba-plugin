// @generated — source-contract de src/sisad-pdfme/schemas/runtime-normalizer.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/runtime-normalizer.ts";

describe("src/sisad-pdfme/schemas/runtime-normalizer.ts", () => {
