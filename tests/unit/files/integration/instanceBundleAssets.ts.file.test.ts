// @generated — source-contract de src/sisad-pdfme/integration/instanceBundleAssets.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/integration/instanceBundleAssets.ts";

describe("src/sisad-pdfme/integration/instanceBundleAssets.ts", () => {
