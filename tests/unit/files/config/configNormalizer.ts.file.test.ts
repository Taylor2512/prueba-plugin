// @generated — source-contract de src/sisad-pdfme/config/configNormalizer.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/config/configNormalizer.ts";

describe("src/sisad-pdfme/config/configNormalizer.ts", () => {
