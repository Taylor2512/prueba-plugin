// @generated — source-contract de src/sisad-pdfme/runtime/executionOrchestration.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/executionOrchestration.ts";

describe("src/sisad-pdfme/runtime/executionOrchestration.ts", () => {
