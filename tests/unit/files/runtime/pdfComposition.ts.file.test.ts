// @generated — source-contract de src/sisad-pdfme/runtime/pdfComposition.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/pdfComposition.ts";

describe("src/sisad-pdfme/runtime/pdfComposition.ts", () => {
