// @generated — source-contract de src/sisad-pdfme/runtime/schemaManifest.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/schemaManifest.ts";

describe("src/sisad-pdfme/runtime/schemaManifest.ts", () => {
