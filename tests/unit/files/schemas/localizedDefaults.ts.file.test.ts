// @generated — source-contract de src/sisad-pdfme/schemas/localizedDefaults.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/localizedDefaults.ts";

describe("src/sisad-pdfme/schemas/localizedDefaults.ts", () => {
