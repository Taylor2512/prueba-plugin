// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/Canvas/snapEngine.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/ui/components/Designer/Canvas/snapEngine.ts";

describe("src/sisad-pdfme/ui/components/Designer/Canvas/snapEngine.ts", () => {
