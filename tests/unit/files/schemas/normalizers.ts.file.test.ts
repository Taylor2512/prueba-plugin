// @generated — source-contract de src/sisad-pdfme/schemas/normalizers.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/normalizers.ts";

describe("src/sisad-pdfme/schemas/normalizers.ts", () => {
