...
test.describe('sisad-pdfme - ui - components - Designer - Canvas - overlays - canvasContextMenuActions.spec.ts', ()=>{
  test('canvasContextMenuActions.spec.ts renders', async ({ page }) => {
