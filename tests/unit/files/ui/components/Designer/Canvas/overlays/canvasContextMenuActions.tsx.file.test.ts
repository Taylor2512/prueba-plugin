// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/Canvas/overlays/canvasContextMenuActions.tsx. Regenerar con `npm test -- source-tests --apply`.
