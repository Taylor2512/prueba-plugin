...
export const SidebarBody = ({ children, className, ...props }: SectionProps) => (
  <div
    className={mergeClassNames(DESIGNER_CLASSNAME + 'right-sidebar-layout-body', 'flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden overscroll-contain px-2 py-2 animate-[rs-stagger-in_180ms_var(--wix-ease-out)_both]', className)}
    {...props}
  >
    {children}
  </div>
