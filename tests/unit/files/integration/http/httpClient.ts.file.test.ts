// @generated — source-contract de src/sisad-pdfme/integration/http/httpClient.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/integration/http/httpClient.ts";

describe("src/sisad-pdfme/integration/http/httpClient.ts", () => {
