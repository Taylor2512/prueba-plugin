// @generated — source-contract de src/sisad-pdfme/react/signatureProviderMerge.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/react/signatureProviderMerge.ts";

describe("src/sisad-pdfme/react/signatureProviderMerge.ts", () => {
