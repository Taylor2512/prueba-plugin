// @generated — source-contract de src/sisad-pdfme/ui/recipientPrefill.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/ui/recipientPrefill.ts";

describe("src/sisad-pdfme/ui/recipientPrefill.ts", () => {
