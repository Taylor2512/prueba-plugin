// @generated — source-contract de src/sisad-pdfme/schemas/graphics/svgGeometry.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/graphics/svgGeometry.ts";

describe("src/sisad-pdfme/schemas/graphics/svgGeometry.ts", () => {
