...
Estos archivos pertenecen al núcleo visual del diseñador. No deben incorporar lógica de host, reglas de firma ni manipulación externa del DOM fuera de los adapters explícitos.
