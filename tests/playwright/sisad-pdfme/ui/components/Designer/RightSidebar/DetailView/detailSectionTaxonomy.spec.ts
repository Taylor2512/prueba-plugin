...
test.describe('sisad-pdfme - ui - components - Designer - RightSidebar - DetailView - detailSectionTaxonomy.spec.ts', ()=>{
  test('detailSectionTaxonomy.spec.ts renders', async ({ page }) => {
