// @generated — source-contract test for src/sisad-pdfme/schemas/shared/fieldChrome.ts
import { describe, expect, it } from 'vitest';
import { statSync } from 'node:fs';
import { absoluteSource, readSource, syntaxDiagnostics, unresolvedRelativeImports } from "../../../helpers/sourceContract";

const SOURCE = "src/sisad-pdfme/schemas/shared/fieldChrome.ts";

describe("src/sisad-pdfme/schemas/shared/fieldChrome.ts", () => {
