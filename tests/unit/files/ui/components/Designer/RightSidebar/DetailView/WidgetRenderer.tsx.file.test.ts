// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/RightSidebar/DetailView/WidgetRenderer.tsx. Regenerar con `npm test -- source-tests --apply`.
