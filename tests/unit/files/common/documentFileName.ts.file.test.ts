// @generated — source-contract de src/sisad-pdfme/common/documentFileName.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/common/documentFileName.ts";

describe("src/sisad-pdfme/common/documentFileName.ts", () => {
