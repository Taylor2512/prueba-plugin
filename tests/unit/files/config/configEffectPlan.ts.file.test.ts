// @generated — source-contract de src/sisad-pdfme/config/configEffectPlan.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/config/configEffectPlan.ts";

describe("src/sisad-pdfme/config/configEffectPlan.ts", () => {
