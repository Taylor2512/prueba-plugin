...
test.describe('sisad-pdfme - ui - components - Designer - Canvas - overlays - floatingSurfaceGeometry.spec.ts', ()=>{
  test('floatingSurfaceGeometry.spec.ts renders', async ({ page }) => {
