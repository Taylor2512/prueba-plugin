// @generated — source-contract de src/sisad-pdfme/common/secrets.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/common/secrets.ts";

describe("src/sisad-pdfme/common/secrets.ts", () => {
