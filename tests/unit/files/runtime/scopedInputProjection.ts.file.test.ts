// @generated — source-contract de src/sisad-pdfme/runtime/scopedInputProjection.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/scopedInputProjection.ts";

describe("src/sisad-pdfme/runtime/scopedInputProjection.ts", () => {
