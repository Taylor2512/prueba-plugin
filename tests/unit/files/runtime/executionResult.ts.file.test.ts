// @generated — source-contract de src/sisad-pdfme/runtime/executionResult.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/executionResult.ts";

describe("src/sisad-pdfme/runtime/executionResult.ts", () => {
