...
describe('resolveReassignActionState', () => {
  ...
  it('keeps the button disabled until there are more than two assignable recipients', () => {
  ...
  it('enables the button once there are at least three assignable recipients', () => {
