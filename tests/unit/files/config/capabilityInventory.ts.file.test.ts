// @generated — source-contract de src/sisad-pdfme/config/capabilityInventory.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/config/capabilityInventory.ts";

describe("src/sisad-pdfme/config/capabilityInventory.ts", () => {
