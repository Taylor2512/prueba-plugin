// @generated — source-contract de src/sisad-pdfme/integration/useSisadPdfmeInstance.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/integration/useSisadPdfmeInstance.ts";

describe("src/sisad-pdfme/integration/useSisadPdfmeInstance.ts", () => {
