// @generated — source-contract de src/sisad-pdfme/converter/img2pdf.ts. Regenerar con `npm test -- source-tests --apply`.
...
describe("src/sisad-pdfme/converter/img2pdf.ts", () => {
