// @generated — source-contract de src/sisad-pdfme/runtime/schemaInteractionState.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/schemaInteractionState.ts";

describe("src/sisad-pdfme/runtime/schemaInteractionState.ts", () => {
