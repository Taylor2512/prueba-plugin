// @generated — source-contract de src/sisad-pdfme/schemas/graphics/svgRenderPlan.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/graphics/svgRenderPlan.ts";

describe("src/sisad-pdfme/schemas/graphics/svgRenderPlan.ts", () => {
