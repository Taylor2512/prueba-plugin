// @generated — source-contract de src/sisad-pdfme/runtime/assignments.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/assignments.ts";

describe("src/sisad-pdfme/runtime/assignments.ts", () => {
