// @generated — source-contract de src/sisad-pdfme/schemas/number/inputPolicy.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/number/inputPolicy.ts";

describe("src/sisad-pdfme/schemas/number/inputPolicy.ts", () => {
