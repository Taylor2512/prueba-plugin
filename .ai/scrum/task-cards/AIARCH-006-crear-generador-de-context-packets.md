...
writer:
readers: []
dependsOn: [AIARCH-004, AIARCH-005]
trace:
  useCases: []
  behaviors: []
  methods: []
...
context:
  ...
  maxTokens: 12000
status: READY
evidence: reports/runtime-platform/evidence/AIARCH-006.copilot.md
---
...
Generar packet desde frontmatter de task-card y registry.
