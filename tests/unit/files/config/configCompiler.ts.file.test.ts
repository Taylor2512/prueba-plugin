// @generated — source-contract de src/sisad-pdfme/config/configCompiler.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/config/configCompiler.ts";

describe("src/sisad-pdfme/config/configCompiler.ts", () => {
