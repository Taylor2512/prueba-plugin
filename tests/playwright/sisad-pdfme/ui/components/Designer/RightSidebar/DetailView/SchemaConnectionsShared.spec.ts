...
test.describe('sisad-pdfme - ui - components - Designer - RightSidebar - DetailView - SchemaConnectionsShared.spec.ts', ()=>{
  test('SchemaConnectionsShared.spec.ts renders', async ({ page }) => {
