// @generated — source-contract de src/sisad-pdfme/runtime/schemaAccess.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/schemaAccess.ts";

describe("src/sisad-pdfme/runtime/schemaAccess.ts", () => {
