// @generated — source-contract de src/sisad-pdfme/config/configPrecedence.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/config/configPrecedence.ts";

describe("src/sisad-pdfme/config/configPrecedence.ts", () => {
