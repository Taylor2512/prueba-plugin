...
import * as dateFns from 'date-fns/locale/index.js';
...
import { mapVerticalAlignToFlex } from '@sisad-pdfme/schemas/text/uiRender';
import {
  DEFAULT_FONT_SIZE,
  DEFAULT_ALIGNMENT,
...
import { DateSchema } from '@sisad-pdfme/schemas/date/types';
import { getExtraFormatterSchema, Formatter } from '@sisad-pdfme/schemas/text/extraFormatter';
...
const injectStyles = (css: string) => {
  if (typeof document !== 'undefined') {
    const styleElementId = 'sisad-pdfme-air-datepicker-styles';
    ...
    propPanel: {
      ...
      defaultSchema: ((): DateSchema => {
        try {
          ...
          const canonical = normalizePluginDefaultSchema(undefined as any, type) as Partial<DateSchema>;
          return {
            ...(canonical as DateSchema),
            name: '',
