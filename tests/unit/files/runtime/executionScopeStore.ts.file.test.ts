// @generated — source-contract de src/sisad-pdfme/runtime/executionScopeStore.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/executionScopeStore.ts";

describe("src/sisad-pdfme/runtime/executionScopeStore.ts", () => {
