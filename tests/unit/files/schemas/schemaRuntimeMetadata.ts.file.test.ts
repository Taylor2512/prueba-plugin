// @generated — source-contract de src/sisad-pdfme/schemas/schemaRuntimeMetadata.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/schemaRuntimeMetadata.ts";

describe("src/sisad-pdfme/schemas/schemaRuntimeMetadata.ts", () => {
