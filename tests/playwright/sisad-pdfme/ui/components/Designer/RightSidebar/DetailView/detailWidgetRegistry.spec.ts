...
test.describe('sisad-pdfme - ui - components - Designer - RightSidebar - DetailView - detailWidgetRegistry.spec.ts', ()=>{
  test('detailWidgetRegistry.spec.ts renders', async ({ page }) => {
