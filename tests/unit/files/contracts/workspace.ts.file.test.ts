// @generated — source-contract de src/sisad-pdfme/contracts/workspace.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/contracts/workspace.ts";

describe("src/sisad-pdfme/contracts/workspace.ts", () => {
