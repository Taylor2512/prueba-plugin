// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/Canvas/canvasViewCapabilities.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/ui/components/Designer/Canvas/canvasViewCapabilities.ts";

describe("src/sisad-pdfme/ui/components/Designer/Canvas/canvasViewCapabilities.ts", () => {
