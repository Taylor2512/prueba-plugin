// @generated — source-contract de src/sisad-pdfme/runtime/__tests__/saveLifecycle.test.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/__tests__/saveLifecycle.test.ts";

describe("src/sisad-pdfme/runtime/__tests__/saveLifecycle.test.ts", () => {
