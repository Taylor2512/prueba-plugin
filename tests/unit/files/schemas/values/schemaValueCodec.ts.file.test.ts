// @generated — source-contract de src/sisad-pdfme/schemas/values/schemaValueCodec.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/values/schemaValueCodec.ts";

describe("src/sisad-pdfme/schemas/values/schemaValueCodec.ts", () => {
