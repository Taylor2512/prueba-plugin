// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/RightSidebar/ListView/ListViewToolbar.tsx. Regenerar con `npm test -- source-tests --apply`.
