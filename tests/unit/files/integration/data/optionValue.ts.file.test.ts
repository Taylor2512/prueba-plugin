// @generated — source-contract de src/sisad-pdfme/integration/data/optionValue.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/integration/data/optionValue.ts";

describe("src/sisad-pdfme/integration/data/optionValue.ts", () => {
