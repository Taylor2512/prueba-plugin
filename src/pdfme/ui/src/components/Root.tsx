...
import { BACKGROUND_COLOR, DESIGNER_CLASSNAME, UI_CLASSNAME } from '../constants.js';
...
const Root = ({ size, scale, children }: Props, ref: Ref<HTMLDivElement>) => {
  ...
  return (
    <div className={DESIGNER_CLASSNAME + 'root'} ref={ref}>
      <div className={DESIGNER_CLASSNAME + 'background'}>
