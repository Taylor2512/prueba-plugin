// @generated — source-contract test for src/sisad-pdfme/shared/index.ts
import { describe, expect, it } from 'vitest';
import { statSync } from 'node:fs';
import { absoluteSource, readSource, syntaxDiagnostics, unresolvedRelativeImports } from "../../helpers/sourceContract";

const SOURCE = "src/sisad-pdfme/shared/index.ts";

describe("src/sisad-pdfme/shared/index.ts", () => {
