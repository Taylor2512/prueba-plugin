// @generated — source-contract de src/sisad-pdfme/common/assetFetch.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/common/assetFetch.ts";

describe("src/sisad-pdfme/common/assetFetch.ts", () => {
