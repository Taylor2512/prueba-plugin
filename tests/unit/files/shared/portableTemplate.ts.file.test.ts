// @generated — source-contract de src/sisad-pdfme/shared/portableTemplate.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/shared/portableTemplate.ts";

describe("src/sisad-pdfme/shared/portableTemplate.ts", () => {
