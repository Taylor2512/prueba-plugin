...
test.describe('sisad-pdfme - ui - components - Designer - Canvas - overlays - SelectionContextToolbar.spec.ts', ()=>{
  test('SelectionContextToolbar.spec.ts renders', async ({ page }) => {
