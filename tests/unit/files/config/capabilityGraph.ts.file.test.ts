// @generated — source-contract de src/sisad-pdfme/config/capabilityGraph.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/config/capabilityGraph.ts";

describe("src/sisad-pdfme/config/capabilityGraph.ts", () => {
