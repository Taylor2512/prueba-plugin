// @generated — source-contract de src/sisad-pdfme/schemas/number/inputGuard.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/number/inputGuard.ts";

describe("src/sisad-pdfme/schemas/number/inputGuard.ts", () => {
