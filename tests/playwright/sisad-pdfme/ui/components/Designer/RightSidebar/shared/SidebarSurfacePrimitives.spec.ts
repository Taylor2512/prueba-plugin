...
test.describe('sisad-pdfme - ui - components - Designer - RightSidebar - shared - SidebarSurfacePrimitives.spec.ts', ()=>{
  test('SidebarSurfacePrimitives.spec.ts renders', async ({ page }) => {
