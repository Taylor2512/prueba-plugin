// @generated — source-contract de src/sisad-pdfme/schemas/signature/signatureAdoptionProfile.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/schemas/signature/signatureAdoptionProfile.ts";

describe("src/sisad-pdfme/schemas/signature/signatureAdoptionProfile.ts", () => {
