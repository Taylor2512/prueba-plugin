...
test.describe('sisad-pdfme - ui - components - Designer - RightSidebar - DetailView - InspectorPrimitives.spec.ts', ()=>{
  test('InspectorPrimitives.spec.ts renders', async ({ page }) => {
