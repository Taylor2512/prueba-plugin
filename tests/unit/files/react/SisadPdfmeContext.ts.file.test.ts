// @generated — source-contract de src/sisad-pdfme/react/SisadPdfmeContext.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/react/SisadPdfmeContext.ts";

describe("src/sisad-pdfme/react/SisadPdfmeContext.ts", () => {
