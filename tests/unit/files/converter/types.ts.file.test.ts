// @generated — source-contract de src/sisad-pdfme/converter/types.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/converter/types.ts";

describe("src/sisad-pdfme/converter/types.ts", () => {
