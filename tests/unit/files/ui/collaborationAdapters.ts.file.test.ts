// @generated — source-contract de src/sisad-pdfme/ui/collaborationAdapters.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/ui/collaborationAdapters.ts";

describe("src/sisad-pdfme/ui/collaborationAdapters.ts", () => {
