// @generated — source-contract de src/sisad-pdfme/runtime/canonicalMerge.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/runtime/canonicalMerge.ts";

describe("src/sisad-pdfme/runtime/canonicalMerge.ts", () => {
