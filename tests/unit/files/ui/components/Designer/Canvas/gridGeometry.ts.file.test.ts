// @generated — source-contract de src/sisad-pdfme/ui/components/Designer/Canvas/gridGeometry.ts. Regenerar con `npm test -- source-tests --apply`.
...
const SOURCE = "src/sisad-pdfme/ui/components/Designer/Canvas/gridGeometry.ts";

describe("src/sisad-pdfme/ui/components/Designer/Canvas/gridGeometry.ts", () => {
